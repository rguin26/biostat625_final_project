...
model_accuracies <- data.frame(
  ...
  "Accuracy" = c(train_rf_cm$overall[1], test_rf_cm$overall[1], train_rf_cm$overall[1], test_rf_cm$overall[1])
)# c(train_rf_cm$overall[1], test_rf_cm$overall[1], train_nn_cm$overall[1], test_nn_cm$overall[1])
