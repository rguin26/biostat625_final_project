...
For this project, we chose to perform analysis using the Clinical Data Set from the Clinical Package of brain cancer data from the National Cancer Institute (NCI) genomic data portal. The version of the dataset we used was released by October 29, 2021, and it contains 1421 different cases of brain cancer.

We chose this topic because we believed that there would be several large datasets available for us to download and work with for the project. We also believe that our project will be somewhat unique, as we plan to combine two different statistical methodologies.
