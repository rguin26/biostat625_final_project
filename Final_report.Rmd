...
nn_train_results <- compute(nn, train_nn_temp)
nn_test_results <- compute(nn, test_nn_temp)
...
Rudra: worked on initial data preprocessing by converting empty values to `NA`, and then did further preprocessing of the data for the neural network model.
